...
return (
    <div className='w-full h-full flex text-white p-5 justify-between items-center'>
            <div className="logo font-bold ml-[10%] flex"><img src='src/assets/logo.png' className='w-9 h-9 mt-[-7px]'/> Glad</div>
            ...
            <div id="hamburger-menu" className='sm:hidden absolute right-[5%]'>
                <img src="/src/assets/bars-menu.png" className='w-6 transform active:scale-120' onClick={() => setShowMenu(!showMenu)}/>
            </div>
            ...
            <div className="absolute top-0 left-[4%]">
                ...
                <div className="mt-3">
                    ...
                    <img src='/src/assets/Email.png' className=''/>
